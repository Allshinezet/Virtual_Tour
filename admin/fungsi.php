<?php
    ...
    function tambahwst($data)
    {
        ...
        $nama_object = htmlspecialchars($data['nama_object']);
        ...
        $conn->query("INSERT INTO tabel_objek(nama_object,gambar_tour,gambar_detail,gambar_360,qrcode,deskripsi) VALUES('$nama_object', '$gambar_tour', '$gambar_detail', '$gambar_360', '$qrcode', '$deskripsi')");
    ...
    function editwst($data) {
        ...
        if(empty($_FILES['gambar_tour']['name']) && empty($_FILES['gambar_detail']['name']) && empty($_FILES['gambar_360']['name']) && empty($_FILES['qrcode']['name'])) {
            $edit = $conn->query("UPDATE tabel_objek SET nama_object = '$nama_object', deskripsi = '$deskripsi' WHERE id_object = '$id_object'");
            if($edit) {
                echo "<script>
                    alert('Berhasil');
            ...
            $gbr = query("SELECT * FROM tabel_objek WHERE id_object = '$id_object'");
            ...
            $gbr2 = query("SELECT * FROM tabel_objek WHERE id_object = '$id_object'");
            ...
            $gbr3 = query("SELECT * FROM tabel_objek WHERE id_object = '$id_object'");
            ...
            $gbr4 = query("SELECT * FROM tabel_objek WHERE id_object = '$id_object'");
            ...
            $edit = $conn->query("UPDATE tabel_objek SET nama_object = '$nama_object', gambar_tour = '$gambar_tour', gambar_detail = '$gambar_detail', gambar_360 = '$gambar_360', qrcode = '$qrcode', deskripsi = '$deskripsi' WHERE id_object = '$id_object'");
            if($edit) {
                echo "<script>
                    alert('Berhasil');
                    document.location.href = 'index.php?page=object';
    ...
    // Hapus
    function hapuswst($id_object) {
        $conn = koneksi();

        $gambar_tour = query("SELECT * FROM tabel_objek WHERE id_object = '$id_object'");
        $lokasi_file = 'assets/img/uploads';
        $gambar_detail = query("SELECT * FROM tabel_objek WHERE id_object = '$id_object'");
        $lokasi_file2 = 'assets/img/uploads';
        $gambar_360 = query("SELECT * FROM tabel_objek WHERE id_object = '$id_object'");
        $lokasi_file3 = 'assets/img/uploads';
        $qrcode = query("SELECT * FROM tabel_objek WHERE id_object = '$id_object'");
        $lokasi_file4 = 'assets/img/uploads';

        $conn->query("DELETE FROM tabel_objek WHERE id_object = '$id_object'");
  ...
  function login($data2) {
    ...
    if($user) {
        ...
        if(password_verify($password, $user['password'])) {
            // Set Session
            $_SESSION['login'] = TRUE;
            header('location:../index.php?page=object');
            exit;
        } else {
            echo "<script>
